...
describe('print animal snapshot',()=>{
    ...
    it('should print correct sting',()=>{

       const expectString = `cat1 15 12
cat2 2 3`;
       const string = animalSnapShot.printAnimalSnapShot(animalLocation,inputId);
       expect(string).toEqual(expectString);
    });
});