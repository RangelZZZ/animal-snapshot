...
const animalLocation = require('../src/get-animal-location');
...
describe('animalLocation', ()=> {
    ...
    it('should get correct animal location', ()=> {

        const expectAnimalLocation = [{
        ...
        const animal = animalLocation.getAnimalLocation(snapShotArray);

        expect(animal).toEqual(expectAnimalLocation);
    });
});
